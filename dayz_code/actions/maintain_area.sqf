...
_requirements = [];
switch true do {
        case (_count <= 10):  {_requirements = [["",0]]};
        case (_count <= 20):  {_requirements = [["",0]]};
        case (_count <= 35):  {_requirements = [["",0]]};
        case (_count <= 50):  {_requirements = [["",0]]};
        case (_count <= 75):  {_requirements = [["",0]]};
        case (_count <= 100): {_requirements = [["",0]]};
        case (_count <= 175): {_requirements = [["",0]]};
        case (_count <= 250): {_requirements = [["",0]]};
        case (_count <= 325): {_requirements = [["",0]]};
        case (_count <= 400): {_requirements = [["",0]]};
        case (_count <= 475): {_requirements = [["",0]]};
        case (_count <= 550): {_requirements = [["",0]]};
        case (_count <= 625): {_requirements = [["",0]]};
        case (_count > 625):  {_requirements = [["",0]]};
};
