...
_wpns = ["M24","M4SPR","Sa58V_RCO_EP1","m16a4","m16a4_acg","FN_FAL_ANPVS4","FN_FAL","BAF_L85A2_RIS_Holo","Mk_48_DZ","PK_DZ","Pecheneg_DZ","ChainSawB","ChainSawP","m240_scoped_EP1_DZE","M60A4_EP1_DZE","M32_EP1","SCAR_L_CQC","SCAR_L_CQC_Holo","SCAR_L_STD_Mk4CQT","SCAR_L_STD_EGLM_RCO","SCAR_L_CQC_EGLM_Holo","SCAR_L_STD_Holo","SCAR_L_CQC_CCO_SD","DMR_DZ"];

_pstl = ["glock17_EP1","M9","M9SD","UZI_SD_EP1","MakarovSD","revolver_gold_EP1"];

_bld = ["CinderBlocks","MortarBucket","ItemTankTrap","ItemPole","PartGeneric","PartPlywoodPack","PartPlankPack","ItemTentOld","ItemTentDomed","ItemTentDomed2","ItemSandbag","ItemWire","workbench_kit","ItemGenerator","forest_net_kit","ItemWoodStairs","ItemWoodStairsSupport","ItemWoodLadder","ItemWoodWall","ItemWoodWallThird","ItemWoodWallDoor","ItemWoodWallWithDoor","ItemWoodWallGarageDoor","light_pole_kit","metal_panel_kit","wood_ramp_kit","bulk_ItemSandbag","bulk_ItemTankTrap","bulk_ItemTankTrapHalf","bulk_PartGeneric","deer_stand_kit","fuel_pump_kit","sandbag_nest_kit","storage_shed_kit","ItemFuelPump","ItemScaffoldingKit"];

_bld_rare = ["metal_floor_kit","30m_plot_kit","cinder_door_kit","cinder_garage_kit","cinder_wall_kit","ItemComboLock","ItemLockbox","ItemBriefcase100oz","ItemHotwireKit","ItemPlotDeed","ItemORP","ItemAVE","ItemLRK","ItemTNK","ItemVault"];

_tools = ["ItemToolbox","ItemCrowbar","ItemKnife","ItemEtool","ItemHatchet_DZE","ItemMatchbox_DZE"];
...
_money = ["ItemSilverBar10oz","ItemGoldBar10oz"];
