...
diag_log format["[EMS]: Major SM7 IKEA Truck Mission has started."];
...
[[(_coords select 0) - 0.5635,(_coords select 1) + 0.3173,0],24,1,"DZMSUnitsMajor"] call DZMSAISpawn;
sleep 5;
...
diag_log format["[EMS]: Major SM7 IKEA has Ended."];
