...
/*---------------------------------------------------------------------------
                        ...
                        ATM Traders. TRADERS BEGIN CAVE

---------------------------------------------------------------------------*/

_vehicle_230023 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [7459.1753, 5563.689, -15.935781], [], 0, "CAN_COLLIDE"];
  _vehicle_0 = _this;
  _this setDir 22.532007;
  _this setPos [7459.1753, 5563.689, -15.935781];
};

_vehicle_230024 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [10944.6265, 654.1006, 0.3879547], [], 0, "CAN_COLLIDE"];
  _vehicle_6 = _this;
  _this setDir -20.742775;
  _this setPos [10944.6265, 654.1006, 0.3879547];
};

_vehicle_230025 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [7448.2822, 5577.2886, 0.513324], [], 0, "CAN_COLLIDE"];
  _vehicle_8 = _this;
  _this setDir 53.176468;
  _this setPos [1009.2822, 18249.2886, 0.513324];
};

_vehicle_230026 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [11712.5293, 15218.2173, 0.799936], [], 0, "CAN_COLLIDE"];
  _vehicle_10 = _this;
  _this setDir 60.169662;
  _this setPos [11712.5293, 15218.2173, 0.799936];
};

_vehicle_230027 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [15320.6338, 9290.0762, 0.271233], [], 0, "CAN_COLLIDE"];
  _vehicle_13 = _this;
  _this setDir -13.327832;
  _this setPos [15320.6338, 9290.0762, 0.271233];
};

_vehicle_230028 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [7373.7813, 4302.438, 0.542929], [], 0, "CAN_COLLIDE"];
  _vehicle_16 = _this;
  _this setDir -37.718872;
  _this setPos [7373.7813, 4302.438, 0.542929];
};

_vehicle_230029 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [15597.3696, 16406.6309, 0.182141], [], 0, "CAN_COLLIDE"];
  _vehicle_19 = _this;
  _this setDir -28.261766;
  _this setPos [15597.3696, 16406.6309, 0.182141];
};

_vehicle_230030 = objNull;
if (true) then
{
  _this = createVehicle ["Infostand_2_EP1", [5542.3696, 8766.6309, 0.182141], [], 0, "CAN_COLLIDE"];
  _vehicle_19 = _this;
  _this setDir -28.261766;
  _this setPos [5542.3696, 8766.6309, 0.182141];
};

/*---------------------------------------------------------------------------

                        ATM Trades End. TRADERS BEGIN CAVE
...
if (true) then
{
  _this = createAgent ["Tanny_PMC", [11700.677, 15211.23663, 0.05175780005], [], 0, "CAN_COLLIDE"];
  _unit_124 = _this;
  _this setDir 28.1598;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
...
if (true) then
{
  _this = createAgent ["Tanny_PMC", [15320.954, 9298.58276, 0.97554183], [], 0, "CAN_COLLIDE"];
  _unit_125 = _this;
  _this setDir 224.19429;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
...
if (true) then
{
  _this = createAgent ["Tanny_PMC", [7355.223, 4340.16821, 0.22649978], [], 0, "CAN_COLLIDE"];
  _unit_126 = _this;
  _this setDir 181.9443;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
  _this allowDammage false; _this disableAI 'FSM'; _this disableAI 'MOVE'; _this disableAI 'AUTOTARGET'; _this disableAI 'TARGET'; _this setBehaviour 'CARELESS'; _this forceSpeed 0;_this enableSimulation false;
};
...
if (true) then
{
  _this = createAgent ["Tanny_PMC", [5536.092, 8778.19617, 0.00271610005], [], 0, "CAN_COLLIDE"];
  _unit_127 = _this;
  _this setDir 138.0876;
  _this setVehicleInit "this allowDammage false; this disableAI 'FSM'; this disableAI 'MOVE'; this disableAI 'AUTOTARGET'; this disableAI 'TARGET'; this setBehaviour 'CARELESS'; this forceSpeed 0;";
  _this setUnitAbility 0.60000002;
