...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>MV-22 Mission</t><br/><t align='center' color='#ffffff'>Bandits have captured a Red Cross MV-22! An informant has advised there is medical supplies, he has updated the map for the location!</t>"];
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>MV-22 Completed</t><br/><t align='center' color='#ffffff'>Survivors have secured the MV-22! Good Job.</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>MV-22 Failed!</t><br/><t align='center' color='#ffffff'>Survivors did not secure the MV-22 in time!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
