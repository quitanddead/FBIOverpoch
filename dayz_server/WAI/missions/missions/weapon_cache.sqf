...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Weapon Crate</t><br/><t align='center' color='#ffffff'>Bandits have obtained a weapon crate! Check your map for the location!</t>"];
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Weapon Crate</t><br/><t align='center' color='#ffffff'>Survivors have secured the Wepaon Cache!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Weapon Crate</t><br/><t align='center' color='#ffffff'>Survivors did not secure the Wepaon Cache Time is up!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
