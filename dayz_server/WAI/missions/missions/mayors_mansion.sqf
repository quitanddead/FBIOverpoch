...
[[[(_position select 0) - 15, (_position select 1) + 15, 8]],"MK19_TriPod",0.8,"TK_INS_Soldier_AT_EP1",1,2,"","Random",true] call spawn_static;
...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Mayor Mission</t><br/><t align='center' color='#ffffff'>The Mayor has gone rogue, go take him and his task force out to claim the black market weapons!</t>"];
...
// Send Top Right message to users , requires Remote message script
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Mayor Mission End</t><br/><t align='center' color='#ffffff'>The rogue mayor has been taken out, who will be the next Mayor of Cherno?</t>"];
customRemoteMessage = ['hint', _hint];
publicVariable "customRemoteMessage";
...
// Send Top Right message to users , requires Remote message script
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Mayor Failed!</t><br/><t align='center' color='#ffffff'>The survivors were unable to capture the Mansion time is up!</t>"];
customRemoteMessage = ['hint', _hint];
publicVariable "customRemoteMessage";
