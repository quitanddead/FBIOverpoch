...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Group Farmers</t><br/><t align='center' color='#ffffff'>A group of farmers have just purchased a helicopter! Go see if you can make it yours...!</t>"];
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Mission completed</t><br/><t align='center' color='#ffffff'>Survivors have stolen the chopper!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Mission failed</t><br/><t align='center' color='#ffffff'>Survivors did not secure the Civilian Aircraft in time!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
