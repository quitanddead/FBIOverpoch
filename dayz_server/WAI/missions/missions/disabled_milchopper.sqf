...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bandit Helicopter</t><br/><t align='center' color='#ffffff'>A bandit helicopter is taking off with a crate of snipers! Save the cargo and keep the guns for yourself.</t>"];
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bandit Helicopter</t><br/><t align='center' color='#ffffff'>Survivors have secured the Armed chopper.</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bandit Helicopter</t><br/><t align='center' color='#ffffff'>Survivors did not secure the armed chopper in time!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
