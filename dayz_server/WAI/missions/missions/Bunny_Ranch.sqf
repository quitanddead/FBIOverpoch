...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bunny Hooker Mission</t><br/><t align='center' color='#ffffff'>The Owner of the Bunny Ranch has been beating his girls again, Go give him a taste of his own medicine</t>"];
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bunny Hooker Mission</t><br/><t align='center' color='#ffffff'>The Hooker Ranch is YOURS! The Girls want to show their gratitude</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bunny Hooker Mission</t><br/><t align='center' color='#ffffff'>News reports of several women found beaten to death!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
