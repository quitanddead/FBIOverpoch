...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bandit Mission</t><br/><t align='center' color='#ffffff'>Bandits have disabled an armed vehicle with lots of chain gun ammo in the gear! Check your map for the location!</t>"];
customRemoteMessage = ['hint', _hint];
publicVariable "customRemoteMessage";

//Send center messages
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Survivors</t><br/><t align='center' color='#ffffff'>Survivors have secured the armed vehicle!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Mission failed</t><br/><t align='center' color='#ffffff'>Survivors did not secure the armed vehicle in time!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
