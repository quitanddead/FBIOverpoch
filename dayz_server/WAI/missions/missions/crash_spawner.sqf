...
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bandit Mission</t><br/><t align='center' color='#ffffff'>The idiot of Bandits have crashed a chopper! Check your map for the location!</t>"];
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Bandit Mission</t><br/><t align='center' color='#ffffff'>Survivors have secured the Bandit crash site!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
    //Send center message
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Mission failed</t><br/><t align='center' color='#ffffff'>Survivors did not secure the crash site in time!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
    //Send center message
