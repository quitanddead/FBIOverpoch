...
"MK19_TriPod",             //Classname of turret
...
//Heli Para Drop
[[(_position select 0),(_position select 1),0],[0,0,0],400,"UH60M_EP1_DZ",10,1,"Random",4,"","USMC_LHD_Crew_Blue","Random",False] spawn heli_para;


[_position,"Disabled Convoy"] execVM "\z\addons\dayz_server\WAI\missions\compile\markers.sqf";
// Send Top Right message to users , requires Remote message script
_hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Ikea Mission</t><br/><t align='center' color='#ffffff'>An Ikea delivery has been hijacked by bandits, take over the convoy and the building supplies are yours!</t>"];
...
if (_playerPresent) then {
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.75'>Ikea Congratulation</t><br/><t align='center' color='#ffffff'>Survivors have secured the building supplies!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	...
	// Send Top Right message to users , requires Remote message script
    _hint = parseText format["<t align='center' color='#52bf90' shadow='2' size='1.55'>Ikea Mission Failed</t><br/><t align='center' color='#ffffff'>Survivors did not secure the convoy in time!</t>"];
    customRemoteMessage = ['hint', _hint];
    publicVariable "customRemoteMessage";
	//Send center message
