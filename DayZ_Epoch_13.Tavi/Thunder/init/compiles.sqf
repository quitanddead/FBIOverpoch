...
if (!isDedicated) then {
	...
	dayz_spaceInterrupt =			compile preprocessFileLineNumbers "Thunder\CFG\dayz_spaceInterrupt.sqf";
    ...
    player_wearClothes =		compile preprocessFileLineNumbers "Thunder\init\player_wearClothes.sqf";
