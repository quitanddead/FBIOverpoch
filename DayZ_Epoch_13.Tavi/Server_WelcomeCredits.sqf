...
_role1names = ["FBI PVP"];
_role2 = "Admins";
_role2names = ["Agent Smith, Agent Brown, Lucidity, Sweets, and many more not named yet..."];
_role3 = "Server mod";
_role3names = ["DayZ Overpoch and Origins"];
...
_role5 = "Server Mods";
_role5names = ["Too many to name."];
_role6 = "Website";
_role6names = ["Coming soon..."];
 
{
	sleep 2;
	_memberFunction = _x select 0;
	_memberNames = _x select 1;
	_finalText = format ["<t size='0.40' color='#000000' align='right'>%1<br /></t>", _memberFunction];
